...
function pedirJugada() {
    ...
    if (eleccion == 1) console.log("Piedra");
    if (eleccion == 2) console.log("Papel");
    if (eleccion == 3) console.log("Tijera");
    console.log("----------------------------");
...
function jugadaRandom() {
    ...
    if (numero == 1) console.log("Piedra");
    if (numero == 2) console.log("Papel");
    if (numero == 3) console.log("Tijera");
    console.log("----------------------------");
...
function compararJugadas() {
    const RESULTADOS_POSIBLES = ['¡Genial, ganaste!', 'Esto fue un empate.', 'Embeces la bida no es komo keremos'];
    ...
    if (eleccionJugador === eleccionComputadora) {
        ...
        // alert("Embeces la bida no es komo keremos")
    }

    // devolvemos la frase con el resultado de la partida
    return alert(resultadoRonda);
}
